...
const vi: Record<string, string> = {
  ...
  "You're up to date.": 'Bạn đang dùng bản mới nhất.',
  'Update available': 'Có bản cập nhật mới',
  'Downloading update…': 'Đang tải bản cập nhật…',
  'Update ready': 'Bản cập nhật đã sẵn sàng',
  'Restart & install': 'Khởi động lại & cài đặt',
  'Update check failed': 'Kiểm tra cập nhật thất bại',
  'Updates only work in the installed app.': 'Cập nhật chỉ hoạt động ở bản đã cài đặt.',
